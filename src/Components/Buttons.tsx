...
const Button: React.FC<Props> = ({
	...
	if (Secondary) {
		classes =
			"py-1 px-4 shadow border-2 hover:bg-stone-200 border-stone-400 hover:shadow-lg hover:-translate-y-0.5 rounded-md font-poppins uppercase font-bold text-stone-500 hover:text-stone-600 text-lg tracking-wide duration-200 hover:scale-105 active:scale-100 active:translate-y-0";
	}
	return (
